const projectData = [
  { title: "Gray Harpoon", image: "/assets/image-1.jpg", isAlternate: false },
  { title: "Blue Raven", image: "/assets/image-2.jpg", isAlternate: true },
  { title: "Red Rubine", image: "/assets/image-3.jpg", isAlternate: false },
  { title: "Purple Fourth", image: "/assets/image-4.jpg", isAlternate: true },
  { title: "Black Fifth", image: "/assets/image-5.jpg", isAlternate: false },
  { title: "Timeless Gold", image: "/assets/image-6.jpg", isAlternate: true },
];
...
const config = {
  SCROLL_SPEED: 0.75,
  LERP_FACTOR: 0.05, //How smooth the scrolling
  BUFFER_SIZE: 15, //scroll delay
  CLEANUP_THRESHOLD: 50, //ya
  MAX_VELOCITY: 120, //controll and smoothness
  SNAP_DURATION: 500,
};
